...
final class FilterViewController: UIViewController {
    ...
    private func setupLayout() {
        ...
        NSLayoutConstraint.activate([
            ...
            filtersContainer.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: 16),
            ...
            filtersStack.topAnchor.constraint(equalTo: filtersContainer.topAnchor, constant: 16),
            filtersStack.bottomAnchor.constraint(equalTo: filtersContainer.bottomAnchor, constant: -16),
    ...
    private func makeFilterRow(for filter: FilterType, index: Int) -> UIView {
        ...
        checkmark.image = filter == selectedFilter ? UIImage(systemName: "checkmark.circle.fill") : UIImage(systemName: "circle")
